...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Los tarjetas que hemos utilizado en nuestra aplicación son:                                                                                                                                 | <img src="../../.gitbook/assets/image (12).png" alt="" data-size="original">        |
| El botón para añadir a los usuarios de una liga:                                                                                                                                            | <img src="../../.gitbook/assets/image (14).png" alt="" data-size="original">        |
| Los botones principales que presentará nuestra aplicación son: **Primary Button:** Para acciónes principales, como guardar. **Secundary Button:** Para acciones segundarias, como cancelar. | <img src="../../.gitbook/assets/image (2) (1) (1).png" alt="" data-size="original"> |
