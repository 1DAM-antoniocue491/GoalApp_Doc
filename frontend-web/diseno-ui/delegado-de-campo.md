...
El delegado de campo tiene acceso a la creación y gestión de nuevos eventos durante el transcurso de un partido, tales como goles, tarjetas, designación del MVP y sustituciones, siempre que su equipo juegue como local. Además, puede registrar estos sucesos en tiempo real, asegurando que la información del encuentro se mantenga actualizada y refleje con precisión todo lo ocurrido en el terreno de juego.
