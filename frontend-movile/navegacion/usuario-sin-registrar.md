...
Además, conteremos con un task en la parte inferior (inicio, liga, partidos, perfil).
...
* **Partido**: Dentro de esta sección, tendremos un task del estado en el que se encuentran los partidos (Directo, Programado, Finalizado) de la liga escogida.&#x20;
